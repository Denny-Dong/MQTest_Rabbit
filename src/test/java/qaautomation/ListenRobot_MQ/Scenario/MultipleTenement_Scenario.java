...
public class MultipleTenement_Scenario {
    ...
    @Test
    public void MultipleTenement_Scenario_1_update_all_info() {
        senderAssignTypeHandler.sender(update_all_map);
    }

    @Test
    public void MultipleTenement_Scenario_2_update_customer_info() {
    ...
    @Test
    public void MultipleTenement_Scenario_3_start_call() throws InterruptedException {
        for (String message :
                startCallList) {
